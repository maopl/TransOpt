...
class HPOResNet(ContinuousOptBenchmark):
    DATASET_NAME = ['svhn', 'cifar10', 'cifar100']

    def __init__(self, task_name, budget, seed, task_id, task_type='non-tabular'):
        super(HPOResNet, self).__init__(task_name=task_name, seed=seed, task_type=task_type, budget=budget)
        np.random.seed(seed)
    ...
    def get_configuration_space(self, seed: Union[int, None] = None) -> CS.ConfigurationSpace:
        ...
        cs.add_hyperparameters([
            ...
            CS.UniformFloatHyperparameter('weight_decay', lower=-10., upper=-5.),
    ...
    def get_fidelity_space(self, seed: Union[int, None] = None) -> CS.ConfigurationSpace:
        ...
        fidel_space.add_hyperparameters([
            CS.UniformFloatHyperparameter("dataset_fraction", lower=0.0, upper=1.0, log=False),
            CS.UniformIntegerHyperparameter("epochs", lower=1, upper=300, log=False)
        ])
    ...
    def get_score(self, configuration: dict):
        ...
        net = ResNet(num_block=int(configuration['number_block']),kernel_size=3, num_classes=n_output).to(device)
        criterion = nn.CrossEntropyLoss()
        optimizer = optim.SGD(net.parameters(), lr=lr, momentum=momentum, weight_decay=configuration['weight_decay'])
    ...
    def objective_function(self, configuration: Union[CS.Configuration, Dict],
        ...
        return {'function_value': float(1-acc),
                'cost': time,
...
if __name__ == '__main__':
    mlp = HPOResNet(task_name='Res', budget=40, seed=0, task_type='non-tabular', dataset_name='svhn')
    configuration = {
        'momentum': -0.1,
        'lr': -0.3,
        'weight_decay': 0.9,
