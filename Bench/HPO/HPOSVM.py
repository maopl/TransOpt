...
from Bench.HPO.openml_data_manager import OpenMLHoldoutDataManager
from Bench.abstract_bench.abstract import AbstractBenchmark
...
class SupportVectorMachine(ContinuousOptBenchmark):
    """
