...
import ConfigSpace
import numpy as np
from Bench.abstract_bench import abstract
logger = logging.getLogger('ConfigOptBenchmark')
import json

class ContinuousOptBenchmark(abstract.AbstractBenchmark):
    ...
    def __init__(self, task_name: str, task_type: str, task_id:int, budget:int,
        ...
        super(ContinuousOptBenchmark, self).__init__(seed, **kwargs)
...
class TabularOptBenchmark(ContinuousOptBenchmark):
