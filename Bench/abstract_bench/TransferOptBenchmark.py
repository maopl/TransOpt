...
class TransferOptBenchmark(abc.ABC, metaclass=abc.ABCMeta):
    ...
    def add_task_to_id(self, insert_id:int,
                       task:Union[ConfigOptBenchmark.ContinuousOptBenchmark, ConfigOptBenchmark.TabularOptBenchmark]):
    ...
    def add_task(self, task:Union[ConfigOptBenchmark.ContinuousOptBenchmark, ConfigOptBenchmark.TabularOptBenchmark]):
        num_tasks = len(self.tasks)
        insert_id = num_tasks
    ...
    def sync_from_handler(self, data_handler: OptTaskDataHandler):
        self.query_nums[self.__id] = data_handler.get_observation_num()
    ...
    def get_task_type(self):
        if isinstance(self.tasks[self.__id], ConfigOptBenchmark.TabularOptBenchmark):
            return 'tabular'
        elif isinstance(self.tasks[self.__id], ConfigOptBenchmark.ContinuousOptBenchmark):
            return 'Continuous'
        else:
