...
class IBPPosterior(SpikeAndSlabPosterior):
    ...
    def __getitem__(self, s):
        if isinstance(s, (int, slice, tuple, list, np.ndarray)):
            ...
            n.prior[dc['mean']._parent_index_] = dc['mean']
            n.prior[dc['variance']._parent_index_] = dc['variance']
            n.prior[dc['binary_prob']._parent_index_] = dc['binary_prob']
            n.prior[dc['tau']._parent_index_] = dc['tau']
