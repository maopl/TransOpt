...
def plot(shape_records,facecolor='w',edgecolor='k',linewidths=.5, ax=None,xlims=None,ylims=None):
    """
    Visualization the geometry of a shapefile
...
def plot_bbox(sf,bbox,inside_only=True):
    """
    Visualization the geometry of a shapefile within a bbox
...
def plot_string_match(sf,regex,field,**kwargs):
    """
    Visualization the geometry of a shapefile whose fields match a regular expression given
