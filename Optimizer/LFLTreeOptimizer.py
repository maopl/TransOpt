...
from External.transfergpbo.models import InputData, TaskData, Model
from External.transfergpbo.models.utils import is_pd, nearest_pd
...
class MTTree(Model):
    def __init__(
        ...
        **options: dict
        ...
        self.model = sklearn.ensemble.ExtraTreesRegressor(
         n_estimators=200,
         max_features='sqrt',
         bootstrap=True,
         random_state=seed,
