...
import gym
from notused_py.evogymbench.modular_envs.wrappers.dummy_vec_env import DummyVecEnv
from notused_py.evogymbench.modular_envs.wrappers.subproc_vec_env import SubprocVecEnv
from notused_py.evogymbench.modular_envs.wrappers.vec_env import VecEnvWrapper
import time 
...
def make_vec_envs(env_name,
    ...
    envs = [
        make_env(env_name, robot_structures[i], seed, i)
