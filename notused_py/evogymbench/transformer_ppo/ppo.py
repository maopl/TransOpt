...
from notused_py.evogymbench.utils.algo_utils import Structure
...
class PPO:
    ...
    verbose=True, ppo_args=None, save_path=None):
        ...
        self.optimizer = optim.Adam(self.agent.prior(), lr=self.args.lr, eps=self.args.EPS)
    ...
    def reset_buffer(self):
        train_env = gym.make(self.args.env_name, body=self.robots_tuple[0][0],
                                connections=self.robots_tuple[0][1])
        sequence_size = 0
    ...
    def train_on_batch(self):
        ...
        for ep in range(self.args.EPOCHS):
            ...
            for batch in batch_sampler:
                ...
                loss.backward()
                nn.utils.clip_grad_norm_(self.agent.prior(), self.args.max_grad_norm)
