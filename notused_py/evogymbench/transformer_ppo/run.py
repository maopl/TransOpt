...
from notused_py.evogymbench.utils.algo_utils import TerminationCondition
import gym
import numpy as np
import random
...
def run(env_name, robots, seed, pop_size, train_iters, ac_type=None, device_num=1):
    ...
    modular_state_dim = train_env.observation_space.shape[0]
    modular_action_dim = train_env.action_space.shape[0]
