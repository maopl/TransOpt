    ...
    def __init__(self, root_dir = "hpob-data/", mode = "v3-test", surrogates_dir="saved-surrogates/"):
        ...
        Inputs:
            ...
            * mode: mode name indicating how to load the data. Options: 
                - v1: Loads HPOBench-B-v1
                - v2: Loads HPOBench-B-v2
                - v3: Loads HPOBench-B-v3
                - v3-test: Loads only the meta-test split from HPOBench-B-v3
                - v3-train-augmented: Loads all splits from HPOBench-B-v3, but augmenting the meta-train data with the less frequent search-spaces.
            * surrogates_dir: path to directory with surrogates models.

        """
        
        print("Loading HPOBench-B handler")
        self.mode = mode
